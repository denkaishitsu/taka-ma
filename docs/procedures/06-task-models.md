...
- 設計書 [§1.3](../design/design-development-system.md#13-モデル配置一覧) / [§2.3 Claude Code](../design/design-development-system.md#23-claude-code-nopus-5--mbp-並行実行) / [§2.4 Gemini](../design/design-development-system.md#24-gemini-36-flashapi--mbp) / [§2.5 Gemma 4 31B](../design/design-development-system.md#25-gemma-4-31bmbp-ローカル) / [§7 軽量タスク処理モデル](../design/details/07-task-models.md#7-軽量タスク処理モデル-セットアップ)
- 通信仕様: [§8.4.x 相互扶助機能(全モデル横断)](../design/details/08-task-routing.md#84x-相互扶助機能全モデル横断ya-ta-の中核価値) / [§8.5 対話型 worker CLI(汎用 PTY 経路)](../design/details/08-worker-execution.md#85-③-sa-ru--worker-cli重量タスク実行実行アダプタ抽象) / [§8.6 Antigravity CLI(subprocess 経路)](../design/details/08-worker-execution.md#86-④-sa-ru--antigravity-clisubprocess-経路) / [§8.7 sa-ru → Gemma 4 31B](../design/details/08-worker-execution.md#87-⑤-sa-ru--gemma-4-31b軽量タスク実行)
